# This spec is directly come from fedora.
# As mentioned, we will keep the changelog.
# Changes:
# 1, remove firebird/interbase support.
# 2, disable dtrace
# 3, disable hardenbuild/we currently donot support it. 
...
* Thu Oct 29 2015 Cjacker <cjacker@foxmail.com> - 5.6.14-1.1
- Initial build for iSoft Enterprise Desktop 4.0
